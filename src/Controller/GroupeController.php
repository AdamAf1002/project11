...
class GroupeController extends AbstractController
{
    ...
    #[Route('/{codegrp}', name: 'app_groupe_show', methods: ['GET'])]
    ...
    #[Route('/{codegrp}/edit', name: 'app_groupe_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{codegrp}', name: 'app_groupe_delete', methods: ['POST'])]
    public function delete(Request $request, Groupe $groupe, GroupeRepository $groupeRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$groupe->getCodegrp(), $request->request->get('_token'))) {
